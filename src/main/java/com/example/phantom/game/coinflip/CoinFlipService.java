...
public class CoinFlipService extends GameService {
    ...
    protected CoinFlipService(CoinFlipSettings settings, UserRepository userRepository, PrivacySettingRepository privacySettingRepository, WalletService walletService, ExperienceService experienceService, ProvablyFairProvider provablyFairProvider, UsageLimiter usageLimiter, GameRepository gameRepository, PrivacyParamValidator privacySettingValidator) {
